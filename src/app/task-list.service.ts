...
export class TaskListService {
  ...
  getTaskListsWithTasks(searchText: string) {
    if(searchText == "")
      return this.webReqService.get('task-group-tasks');

    return this.webReqService.get(`task-group-tasks/?search_text=${searchText}`);
  }
